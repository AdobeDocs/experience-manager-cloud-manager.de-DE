...
[Experience Hub](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/experience-hub/experience-hub) ist ein Zugriffspunkt auf AEM, der an die Anforderungen Ihres Unternehmens angepasst ist. Geben Sie Adobe Details zu Ihren bestehenden AEM-Benutzeroberflächenerweiterungen, damit Sie sie effizient in Experience Hub aktivieren können.
...
An der Beta-Version teilnehmen? Senden Sie eine E-Mail an [beta_exphubextensibility@adobe.com](mailto:beta_exphubextensibility@adobe.com) mit Ihrer Adobe-OrgID und einer kurzen Beschreibung der Anpassung, die Sie vornehmen möchten.
...
Teilnehmen? Senden Sie eine E-Mail an [beta_quickbuild_cmpipelines@adobe.com](mailto:beta_quickbuild_cmpipelines@adobe.com) mit Ihrer Adobe-OrgID und Programm-ID.
