...
Um frühzeitig Zugriff auf kommende Funktionen zu erhalten, bevor sie allgemein veröffentlicht werden, nehmen Sie an den Beta-] von [!UICONTROL Cloud Manager teil.
...
[Experience Hub](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/experience-hub/experience-hub) ist der zentrale Zugriffspunkt für AEM, der auf die Anforderungen Ihres Unternehmens zugeschnitten ist. Geben Sie Adobe Details zu Ihren bestehenden Erweiterungen der AEM-Benutzeroberfläche, damit Sie sie in Experience Hub aktivieren können.
...
Um teilzunehmen, senden Sie eine E-Mail an ](mailto:beta_exphubextensibility@adobe.com)0}beta_exphubextensibility@adobe.commit Ihrer Adobe-OrgID und einer kurzen Beschreibung der Anpassung, die Sie erstellen möchten.[
