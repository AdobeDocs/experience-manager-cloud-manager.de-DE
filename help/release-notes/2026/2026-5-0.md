...
Ein neues Build-Modell kompiliert nur geänderte Module (nicht das gesamte Repository) mithilfe des Caching auf Modulebene, wodurch die Erstellungszeiten reduziert werden. Dies gilt für Code-Qualität- und Full-Stack-Pipelines.
