...
>
>Weitere Informationen zur Adobe Admin-Konsole finden Sie in der Dokumentation zur [Admin-Konsole](https://helpx.adobe.com/enterprise/using/admin-console.html).
...
Weitere Informationen zum Aktualisieren Ihrer AEM-Instanz auf 6.4 finden Sie unter [Aktualisieren auf AEM 6.4](https://helpx.adobe.com/experience-manager/6-4/sites/deploying/using/upgrade.html).
...
*Beispiel*: Wenn ein Kunde [www.myco.com](http://www.myco.com/) und [www.myotherco.com](http://www.myotherco.com,/) als Produktions-Hostnamen und stage-myco.adobecqms.net als ihren Stage-Hostnamen verwendet, muss eine Anforderung wie diese angemessen reagieren:
